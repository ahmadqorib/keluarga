<div class="panel panel-default">
	<div class="panel-heading">Edit Data Keluarga</div>
		...
		<?php echo form_open('',$atribut); ?>
			<div class="form-group">
				...
				<div class="col-md-4 col-sm-5">
					<input type="text" name="no" class="form-control input-sm" placeholder="masukkan no kk..." value="<?php echo $tampil[0]->no_kk; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Kepala Keluarga :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="nama" class="form-control input-sm" placeholder="masukkan nama kepala keluarga..." value="<?php echo $tampil[0]->kepala_keluarga; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Alamat :</label>
				<div class="col-md-4 col-sm-5">
					<textarea name="alamat" class="form-control input-sm" placeholder="masukkan alamat..."><?php echo $tampil[0]->alamat; ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">RT :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="rt" class="form-control input-sm" placeholder="masukkan RT..." value="<?php echo $tampil[0]->rt; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">RW :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="rw" class="form-control input-sm" placeholder="masukkan RW..." value="<?php echo $tampil[0]->rw; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Desa :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="desa" class="form-control input-sm" placeholder="masukkan desa..." value="<?php echo $tampil[0]->desa; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Kecamatan :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="kecamatan" class="form-control input-sm" placeholder="masukkan kecamatan..." value="<?php echo $tampil[0]->kecamatan; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Kabupaten :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="kabupaten" class="form-control input-sm" placeholder="masukkan kabupaten..." value="<?php echo $tampil[0]->kabupaten; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Kode Pos :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="pos" class="form-control input-sm" placeholder="masukkan kode pos..." value="<?php echo $tampil[0]->kode_pos; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-3">Propinsi :</label>
				<div class="col-md-4 col-sm-5">
					<input type="text" name="propinsi" class="form-control input-sm" placeholder="masukkan propinsi..." value="<?php echo $tampil[0]->propinsi; ?>">
				</div>
			</div>
			<div class="form-group">
